...
import { GraduationCap, Lock, ArrowRight, Loader2, Eye, EyeOff, CheckCircle2 } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[#080B1A] flex items-center justify-center px-6">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-display font-bold text-white mb-2">Đặt lại mật khẩu</h1>
          <p className="text-sm text-white/40">Chọn mật khẩu mới ít nhất 6 ký tự</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-8">
          {done ? (
            <div className="text-center space-y-3">
              ...
              <p className="text-sm text-white">Đặt lại mật khẩu thành công.</p>
              <p className="text-xs text-white/40">Đang chuyển đến đăng nhập...</p>
            </div>
          ) : (
